              ...
              <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-6 max-lg:gap-12">
                  ...
                  <div class="w-full lg:sticky top-0 sm:flex gap-2">
                      <div class="sm:space-y-3 w-16 max-sm:w-12 max-sm:flex max-sm:mb-4 max-sm:gap-4">
                          <img src={product.image} alt="Product1" class="w-full cursor-pointer rounded-md outline" />
                          <img src={product.image} alt="Product2" class="w-full cursor-pointer rounded-md" />
                          <img src={product.image} alt="Product3" class="w-full cursor-pointer rounded-md" />
                          <img src={product.image} alt="Product4" class="w-full cursor-pointer rounded-md" />
                      </div>
                      <img src={product.image} alt="Product" class="w-4/5 rounded-md object-cover" />
                  </div>
                  ...
                  <div>
                      ...
                      <div class="flex flex-wrap gap-4 mt-4">
                          ...
                          <p class="text-gray-400 text-xl"><strike>${product.price * 1.2}</strike> <span class="text-sm ml-1.5">Tax included</span></p>
                      </div>
                      ...
                      <div class="mt-8">
                          ...
                          <div class="space-y-3 mt-4">
                              <div class="flex items-center">
                                  <p class="text-sm text-gray-800 font-bold">{product.rating.rate}</p>
